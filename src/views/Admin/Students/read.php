...
<body>
    ...
    <div class=" h-screen bg-gray-900 text-white pl-6 pt-6 w-[250px]">
        ...
        <div class="h-screen bg-gray-200 w-[1020px] flex flex-col">
            ...
            <div class="flex justify-between pr-20 pb-10">
                <h2>Informacion de Alumnos</h2>
                <button class="w-[100px] h-[30px] bg-blue-700 rounded-md"><a href="create" class="text-xs text-white">Agregar Alumno</a></button>
            </div>

            <table>
                <thead class="border-[1px]  border-gray-600 flex">
                    <tr class="bg-gray-300">
                        <th class="border-[1px] border-gray-500 w-[79px]  ">ID</th>
                        <th class="border-[1px] border-gray-500 w-[150px]">Dni</th>
                        ...
                        <th class="border-[1px] border-gray-500 w-[150px]">Fecha de Nacimiento</th>
                        <th class="border-[1px] border-gray-500 w-[57px] ">Accion</th>
                    </tr>
                </thead>
                <tbody class="bg-white ">
                    ...
                    ?>
                        <tr class="flex">
                            ...
                            <td class="border-[1px] border-gray-500  w-[150px] flex justify-center "><?= $usuario["dni"] ?></td>
                            ...
                            <td class="border-[1px] border-gray-500  w-[150px] flex justify-center "><?= $usuario["fechaNacimiento"] ?></td>
                            <td class="border-[1px] border-gray-500  w-[58px]  flex justify-center">
                                <form action="/delete" method="post" class="bg-white">
                                    <a href="/edit?id=<?= $usuario["id"] ?>">Editar</a>
